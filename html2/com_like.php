...
if (isset($_SESSION['nickname'])) {
    ...
    if (isset($checkifalreadyrow)) {
        if ($checkifalreadyrow[3] == 'like') {
            ...
            $changelikeandhate = "UPDATE com SET good=good+1 , hate=hate-1 where id={$_SESSION['id']}";
            mysqli_query($conn, $changelikeandhate);
            $changefromlikebutton = "UPDATE likebutton SET type='like' where postid={$_SESSION['id']} and nickname='{$_SESSION['nickname']}'";
