...
<input type='text' name='new_nickname' class='form-control' value='{$row[1]}' placeholder='변경 하고 싶은 닉네임을 입력해주세요' required>
<br><input type='password' name='new_pw' class='form-control' value='{$row[2]}' placeholder='변경 하고 싶은 비밀번호를 입력해주세요' required>
<br><br><button role='submit' name='update' class='btn btn-warning'>정보 수정하기</button></form> 
<form action='com_pf.php' method='post'><button role='submit' name='remove' class='btn btn-danger'>계정 삭제하기</button> 
</form><br><br><form action='com_create.php' method='post'><button role='submit' class='btn btn-warning' name='partner'>파트너쉽 신청하기</button></form>
